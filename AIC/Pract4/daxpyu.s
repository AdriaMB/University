...
loop:
    ...
    fld f2, 8(t1)
    fld f3, 16(t1)
    fadd.d f7, f4, f1    # x[n]*a + y[n]
    fadd.d f8, f5, f2
    fadd.d f9, f6, f3
    fsd f7, 0(t2)        # z[n]
    fsd f8, 0(t2)
    fsd f9, 0(t2)
    addi t0, t0, 3       # next element from x
    addi t1, t1, 32      # next element from y
    sub t4, t3, t1       # t4 = final address - incrementing address
    addi t2, t2, 32      # next element from z
    bnez t4, loop
