...
public class MarsEnv extends Environment {
    ...
    class MarsModel extends GridWorldModel {
        ...
        private MarsModel() {
            ...
            try {
                setAgPos(0, 0, 0);
	   int col = (int)(Math.random()*GSize);
	   int fil = (int)(Math.random()*GSize);

                Location r2Loc = new Location(col, fil);

	   col = (int)(Math.random()*GSize);
	   fil = (int)(Math.random()*GSize);

                Location r3Loc = new Location(col, fil);

	   col = (int)(Math.random()*GSize);
	   fil = (int)(Math.random()*GSize);

                Location r4Loc = new Location(col, fil);
