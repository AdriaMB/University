...
root_agent = Agent(
    ...
    # Hay que remarcarle que use las herramientas. Sino, podría no utilizarlas
    instruction=(
    ...
    ), # Vale la pena remarcarle también el formato del output. En este caso no se hace, se le da libertad
