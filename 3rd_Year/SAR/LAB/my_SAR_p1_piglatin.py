...
class Translator():
    ...
    def translate_word(self, word:Text) -> Text:
        ...
        new_word = word
        # The word contains a number or other non- character
        ...
        # else, the word stars by a consonant
            ...
            first_vowel = None    # default index (En python los índices pueden ser negativos sin que eso rompa el programa: simplemente comienza por atrás... Por esta razón, mejor dejar first_vowel como null y no como un valor negativo)
            for i in word:
                if i in vowels:
    ...
    def translate_file(self, filename:Text):
        ...
        with (
            ...
            open(name[0] +"_latin.txt", "w", encoding="utf-8") as new_file
        ):
