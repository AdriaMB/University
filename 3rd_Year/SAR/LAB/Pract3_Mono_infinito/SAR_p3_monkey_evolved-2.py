...
# Recibe el nombre de un fichero de lm y opcionalmente: 
#   un valor n
#   un númer de frases
#   un prefijo
# Utiliza el lm de n-gramas para generar frases
# Si se proporciona un prefijo, todas las frases comienzan por él
