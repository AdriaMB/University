        ...
        switch (opcode) {
            ...
            case OPCODE_OP_FP:
                ...
                if (Rfp[I_S1].rob == MARCA_NULA) {
                    /*** RS[s].V1 --> Value of the first operand ***/
                    /*** RS[s].Q1 --> TAG of the first operand; ***/
                    ...
                    /* Copy the value from the Reorder Buffer */
                    RS[s].V1 = RB[Rfp[I_S1].rob].valor;

                } else {

                    /* Copy the mark of the instruction that will modify the value */
                ...
                Rfp[rd].rob = b; // b IS THE IDENTIFIER OF THE ROB
